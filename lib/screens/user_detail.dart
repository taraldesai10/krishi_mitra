...
class UserDetailPage extends StatefulWidget {
  ...
  static String? profilUrl;
  static String? userName;
  static bool? forProfile;
...
class _UserDetailPageState extends State<UserDetailPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: StreamBuilder(
          ...
          builder: (context, snapshot) {
            if (currentUser!.uid == null) {
              UserDetailPage.forProfile = true;
              return Center(
                child: Container(
              ...
              UserDetailPage.forProfile = false;
            }
            return SizedBox();
          },
        )
        ...
        //             ),
        //             onPressed: () async {
        //               UserDetailPage.userName = txtUserNameController.text;
        //               if (_image == null) {
        //                 log("no image");
        //               } else {
        //                 final ref = FirebaseStorage.instance
        ...
        //                     .child(".jpg");
        //                 await ref.putFile(_image!);
        //                 UserDetailPage.profilUrl = await ref.getDownloadURL();
        //               }
        //               setState(() {
        //                 ProfileStorage.addProfileData();
        //               });
